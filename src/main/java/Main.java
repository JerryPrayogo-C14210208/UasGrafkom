...
public class Main {
    ...
    private ArrayList<Object> objects
            = new ArrayList<>();
    private ArrayList<Object> hitbox
            = new ArrayList<>();
    ...
    public void init(){
        ...
        camera.setPosition(-200.0f,70.0f,0.0f);
        camera.setRotation((float)Math.toRadians(0.0f),(float)Math.toRadians(0.0f));
        skybox = new SkyBoxCube();
        //code
        hitbox.add(new Sphere(
                Arrays.asList(
        ...
        hitbox.get(0).translateObject(-300f,40f,-168f);
...
//  gedung ke 15
        ...
        objects.get(46).translateObject(-20.0f,0.2f,-25.0f);
        ...
        objects.get(47).translateObject(-25.0f,-0.10f,-25.0f);
        // phoon bagian 2
        objects.add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
        ...
        objects.get(49).translateObject(-13.50f,0.2f,-25.0f);
        // cross
        objects.add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
        ...
        objects.get(50).translateObject(-18.0f,0.2f,-25.0f);
        // cross
        objects.add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
        ...
        objects.get(51).translateObject(-15.0f,0.2f,-25.0f);
        objects.add(new Sphere(
                Arrays.asList(
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.vert", GL_VERTEX_SHADER),
                        new ShaderProgram.ShaderModuleData("resources/shaders/scene.frag", GL_FRAGMENT_SHADER)
        ...
        objects.get(52).rotateObject(1.5f,0f,1f,0f);
        objects.get(52).translateObject(-15.0f,0.50f,-15.0f);
...
int colideloop = 500;
    public void input(){
        if (checkCollision(objects.get(1).getUpdatedVertice(), hitbox.get(0).getUpdatedVertice())){
        ...
        if (window.isKeyPressed(GLFW_KEY_UP) && colide == 0) {
            objects.get(1).translateObject(0f, 0f, -0.1f);
//            System.out.println(objects.get(1).getCenterPoint());
        }
        if (window.isKeyPressed(GLFW_KEY_DOWN) && colide == 0) {
            objects.get(1).translateObject(0f, 0f, 0.1f);
        }
        if (window.isKeyPressed(GLFW_KEY_LEFT) && colide == 0) {
            objects.get(1).translateObject(-0.1f, 0f, 0f);
        }
        if (window.isKeyPressed(GLFW_KEY_RIGHT) && colide == 0) {
            objects.get(1).translateObject(0.1f, 0f, 0.0f);
        }
        if(window.isKeyPressed(GLFW_KEY_LEFT_CONTROL) && colide == 0){
            objects.get(1).translateObject(0f, -0.1f, 0.0f);
        }
        if(window.isKeyPressed(GLFW_KEY_SPACE) && colide == 0){
        ...
        if(mobil2 > 56 && mobil2 < 58 || mobil2 > 15.98 && mobil2 < 17.99)   {
            System.out.println("cmdkcmd: " + mobil1);
            float tempX = objects.get(52).getModel().get(3,0);
            float tempY = objects.get(52).getModel().get(3,1);
            float tempZ = objects.get(52).getModel().get(3,2);

            objects.get(52).translateObject(-tempX,-tempY,-tempZ);
            objects.get(52).rotateObject(0.015f,0f,1f,0f);
            objects.get(52).translateObject(tempX,tempY,tempZ);
        }
        //maju
        if (mobil2 > 58){
            objects.get(52).translateObject(-0.1f,0.0f,0.0f);
