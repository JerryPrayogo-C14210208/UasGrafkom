...
//        uniformsMap.createUniform("lightPos");
    ...
    public void drawSetup(Camera camera, Projection projection){
        ...
        if(spherename == "pesawat") {
            ...
            uniformsMap.setUniform("dirLight.diffuse", new Vector3f(0.3f, 0.3f, 0.3f));
...
//            System.out.println(centerPoint.get(0)+" " + centerPoint.get(1)+ " " + centerPoint.get(2));
            Vector3f[] _pointLightPositions = {
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)-30),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)-24),
                    new Vector3f(centerPoint.get(0)-1f,centerPoint.get(1)+10,  centerPoint.get(2)-18),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)-12),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)-6),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)-2),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+4),
                    new Vector3f(centerPoint.get(0)-1f,centerPoint.get(1)+10,  centerPoint.get(2)+10),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+16),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+22),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+28),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+30),
                    new Vector3f(centerPoint.get(0)-1f,centerPoint.get(1)+15,  centerPoint.get(2)+34),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+24),
                    new Vector3f(centerPoint.get(0)-1f, centerPoint.get(1)+10,  centerPoint.get(2)+28),
...
//            new Vector3f(0.7f, -10.2f, centerPoint.get(2) - 20.0f),
            ...
            for (int i = 0; i < _pointLightPositions.length; i++) {
                ...
                uniformsMap.setUniform("pointLights[" + i + "].ambient", new Vector3f(0.02f, 0.02f, 0.02f));
                ...
                uniformsMap.setUniform("pointLights[" + i + "].linear", 0.05f);
                uniformsMap.setUniform("pointLights[" + i + "].quadratic", 0.0000032f);
            }
...
//            uniformsMap.setUniform("dirLight.position",new Vector3f(-0.2f,30.0f,-0.3f));
        ...
        uniformsMap.setUniform("dirLight.diffuse", new Vector3f(10000000.4f,10000000.4f,10000000.4f));
